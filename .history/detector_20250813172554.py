...
def load_model():
    ...
    model_path = r"C:\Users\HP\Desktop\Others\Facial-Emotion-Recognition\weights\best_model.pth"
...
def display_result(image_path, predictions):
    ...
    text_bg = np.zeros((150, 400, 3), dtype=np.uint8)
...
def main():
    ...
    while True:
        ...
        # Ask to continue
        response = input("\nWould you like to analyze another image? (y/n): ")
        if response.lower() != 'y':
            break
